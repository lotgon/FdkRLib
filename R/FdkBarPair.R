...
ComputeGetPairBars <- function(symbol, barPeriodStr, startTime, endTime, barCountDbl) {
  clrCallStatic('RHost.FdkBars', 'ComputeGetPairBars', symbol, barPeriodStr, startTime, endTime, barCountDbl)
}
